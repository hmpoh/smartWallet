...
//                        Query query = groupAccountIdReff.orderByChild("Account Id").equalTo();
                       ...
                       // mDatabase.child("Groups").child(getIntent().getStringExtra("groupName")).child("Participants").child(mobileNumber).child("Amount Paid").setValue(strRaisedAmount);

                        mDatabase.child("Groups").child(getIntent().getStringExtra("groupName")).child("Participants").child(mobileNumber).child("Amount Paid").setValue(doubleAmount.toString());
                        ...
                        intent.putExtra("SKEY",getIntent().getStringExtra("SKEY"));
